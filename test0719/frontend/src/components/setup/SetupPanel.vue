<template>
  <div class="setup-panel">
    ...
    <ul class="panel-benefits">
      ...
      <li>
        ...
        <div>
          ...
          <span class="benefit-desc">PPT用于课堂演示；教案将纳入课堂评价维度</span>
        </div>
      </li>
    </ul>
    ...
    <p v-if="hasPptInput" class="start-hint ppt-hint">
      已检测到 PPT：进入课堂前会自动执行“PPT 转 PDF 预转换”。
    </p>
